...
public class Curso {
    ...
    public void addCursoUsuario(CursoUsuario cursoUsuario) {
        if (cursoUsuario == null) {
            throw new IllegalArgumentException("CursoUsuario no puede ser nulo");
        }
    ...
    public void setId(Long id) {
        if (id == null || id <= 0) {
            throw new IllegalArgumentException("El ID del curso debe ser positivo y no nulo");
        }
        this.id = id;
    }
    ...
    public void setDescripcion(String descripcion) {
        if (descripcion == null || descripcion.isEmpty()) {
            throw new IllegalArgumentException("La descripción del curso no puede ser nula o vacía");
        }
